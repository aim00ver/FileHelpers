...
namespace FileHelpers.Dynamic
{
    ...
    public abstract class ClassBuilder
    {
        ...
        private void ValidateClass()
        {
            ...
            #region added on merge, not tested
            ...
            using (var peStream = new MemoryStream())
            {
                using (var pdbStream = new MemoryStream())
                {
                    ...
                    if (errors.Any())
                    {
                        ...
                        //?ErrorCompilingExpression"Error Compiling Expression: \r\n {0} "
                        throw new DynamicCompilationException("FileHelperMsg_ErrorCompilingExpression", new List<string>() { error.ToString() }, classStr, null);
                    }
